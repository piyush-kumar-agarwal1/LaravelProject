...
@section('content')
    ...
    <section class="section section--bg-offwhite-three featured-popular-courses main-popular-course">
                        ...
                        <div class="row">
                            @forelse ($designCourses as $dc)
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img src="{{asset('uploads/courses/' . $dc->image)}}" alt="images"
                                                    class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
        ...
        <div class="featured-popular-courses-shape">
            <img src="{{asset('frontend/dist/images/shape/dots/dots-img-12.png')}}" alt="Shape" class="img-fluid dot-06" />
                ...
                <div class="col-lg-6 order-1 order-lg-0">
                    <div class="learning-rules-ends">
                        ...
                        <div class="learning-rules-ends-circle">
                            <img src="{{asset('frontend/dist/images/shape/l03.png')}}" alt="shape" class="img-fluid" />
                        </div>
