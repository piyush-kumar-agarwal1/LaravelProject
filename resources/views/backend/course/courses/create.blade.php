                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                name="courseDescription_en">{{old('courseDescription_en')}}</textarea>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tag">
                                                <option value="popular" @if(old('tag') == 'popular') selected @endif>Popular
                                                </option>
                                                <option value="featured" @if(old('tag') == 'featured') selected @endif>
                                                    Featured
                                                </option>
                                                <option value="upcoming" @if(old('tag') == 'upcoming') selected @endif>
                                                    Upcoming
                                                </option>
                                            </select>
                                        </div>
