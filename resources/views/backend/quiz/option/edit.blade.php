                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="optionText"
                                                value="{{old('optionText', $option->option_text)}}">
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="is_correct">
                                                <option value="1" @if(old('is_correct', $option->is_correct) == 1) selected
                                                @endif>Correct</option>
                                                <option value="0" @if(old('is_correct', $option->is_correct) == 0) selected
                                                @endif>Wrong</option>
                                            </select>
                                        </div>
                                    </div>
